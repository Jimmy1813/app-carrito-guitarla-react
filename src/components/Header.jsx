...
export default function Header({cart, removeFromCart, increaseQuantity, decrementarQuantity, clearCart}) {
                    ...
                    {cart.map( guitar => (
                      <tr key={guitar.id}>
                        ...
                        <td className="flex align-items-start gap-4">
                          <button type="button" className="btn btn-dark" onClick={() => decrementarQuantity(guitar.id) }>
                            -
                          </button>
                            {guitar.quantity}
